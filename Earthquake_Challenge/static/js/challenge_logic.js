...
let baseMaps = {
  "Streets Style": streets,
  "Satellite Style": satelliteStreets, 
  "Light Style": lightStreets
};
...
// 2. Add a reference to the tectonic plates group and major earthquake data to the overlays object.
let overlays = {
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  // create styling for tectonic plates
  ...
  L.geoJSON(data, {
    pointToLayer: function(geometry){
      return L.polygon(geometry.coordinates);
    },
    style: styleInfo2,
